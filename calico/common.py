                    ...
                    for t in "in", "out":
                        ...
                        if ip:
                            ...
                            issues.append("%s_ip was not specified a %s entry.",
                                          t, n_key)
                    if canonical["in"] and canonical["out"]:
                        canonical_nm.append({"in_ip": canonical["in"],
                                             "out_ip": canonical["out"]})
